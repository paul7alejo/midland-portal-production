    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-base text-gray-700">
          Real-time operational metrics for Midland Sleep
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white border border-sand rounded-lg p-6 space-y-3">
          <div className="flex items-center justify-between">
            <h3 className="text-base font-medium text-gray-700">Portal Reorders</h3>
            <ShoppingBag className="h-6 w-6 text-deep-teal" />
          </div>
          <p className="text-5xl font-bold text-navy">47</p>
          <p className="text-base text-gray-700">This month</p>
        ...
        <div className="bg-white border border-sand rounded-lg p-6 space-y-3">
          ...
          <p className="text-5xl font-bold text-navy">23</p>
          <p className="text-base text-gray-700">This month</p>
        ...
        <div className="bg-white border border-sand rounded-lg p-6 space-y-3">
          ...
          <p className="text-5xl font-bold text-navy">8</p>
        ...
        <div className="bg-white border border-sand rounded-lg p-6 space-y-3">
          ...
          <p className="text-5xl font-bold text-navy">142</p>
      ...
      <div className="bg-white border border-sand rounded-lg p-6 space-y-4">
        <div>
          ...
          <p className="text-base text-gray-700">
            Monthly inbound calls since portal launch
          </p>
        </div>
        <div className="h-80">
      ...
      <div className="bg-white border border-sand rounded-lg p-6 space-y-4">
        ...
        <div className="space-y-3">
          {/* Alert 1 */}
          <div className="border border-amber/30 bg-amber/5 rounded-lg p-4 flex items-center justify-between gap-4 min-h-[64px]">
            ...
            <Link
              href="/admin/outreach"
              className="bg-deep-teal text-white px-6 py-3 rounded-full text-base font-medium hover:bg-deep-teal/90 transition-colors whitespace-nowrap min-h-[44px] flex items-center"
            >
              View in Outreach →
            </Link>
          </div>
